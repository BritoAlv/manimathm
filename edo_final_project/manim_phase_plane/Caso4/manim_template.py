...
if __name__ == '__main__':
    import subprocess
    params = 'manim -pqk manim_template.py Case1'.split()
...
def ode_system(_y):
    value1 = _y[0] * (a.get_value() * b.get_value() * (1 - _y[0] / b.get_value()) - c.get_value() * _y[1] - d.get_value())
    value2 = _y[1] * (e.get_value() * (ff.get_value() - _y[1]) + g.get_value() * _y[0] * (hh.get_value() - _y[0]) - i.get_value() * _y[0])
